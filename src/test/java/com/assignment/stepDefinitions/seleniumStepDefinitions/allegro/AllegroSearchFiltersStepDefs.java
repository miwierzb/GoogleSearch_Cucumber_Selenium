...
public class AllegroSearchFiltersStepDefs {
    ...
    public void verifyIfCorrectFilterIsApplied(String filterFrom, String filterTo){
        ...
        Assert.assertEquals("Filter '" + filterFrom + "' is not applied", "od " + filterFrom + " GB", allegroStepData.allegroSearchFilters.getChosenAppliedFiltersText(0));
        Assert.assertEquals("Filter '" + filterTo + "' is not applied", "do " + filterTo + " GB", allegroStepData.allegroSearchFilters.getChosenAppliedFiltersText(1));
    }
