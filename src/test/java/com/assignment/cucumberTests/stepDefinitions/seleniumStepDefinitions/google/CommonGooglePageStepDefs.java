...
public class CommonGooglePageStepDefs {

    private AllegroStepData allegroStepData;

    public CommonGooglePageStepDefs(AllegroStepData allegroStepData) {
    ...
    public void verifyIfDyskiIPamieciPrzenosnePageIsLoaded() {
        ...
        Assert.assertTrue("'Dyski i pamieci przenosne' page is not loaded - wrong url",
                allegroStepData.allegroDyskiIPamieciPrzenosnePage.isLoaded());
        Assert.assertTrue("'Dyski i pamieci przenosne' text is not displayed",
                allegroStepData.allegroDyskiIPamieciPrzenosnePage.isDyskiIPamieciPrzenosneTextDisplayed());
        Assert.assertTrue("'Dyski i pamieci przenosne' breadcrumb is not displayed",
                allegroStepData.allegroDyskiIPamieciPrzenosnePage.isDyskiIPamieciPrzenosneBreadcrumbDisplayed());
    }
    ...
    public void clickDyskiZewnetrzneIPrzenosneButton() {
        ...
        allegroStepData.allegroDyskiZewnetrzneIPrzenosnePage =
                allegroStepData.allegroDyskiIPamieciPrzenosnePage.clickDyskiZewnetrzneIPrzenosneButton();
    }
